...
$dato['numconsulta']         = $movements[$i]['numconsulta'];
        ...
        if($movements[$i]['Antedentes']!='Si'){
            //NO TIENE
            //$dato['Antedentes']         ='<label style="color:white;background-color:red">Sí</label>';
            $dato['Antedentes']         = '<button type="button" style="color:white;background-color:#488753" class="pull-right btn btn-default" id="sendEmail">No
            </button>';
            $dato['Comentario']         =  'NO HAY PROCESOS PENALES ASOCIADOS';
        } else { //si tiene
            $dato['Antedentes']         = '<button type="button" style="color:white;background-color:#9F4C44" class="pull-right btn btn-default" id="sendEmail">Sí
            </button>';
       ...
       if($movements[$i]['estado']=='Aprobado'){
        //SI TIENE
        //$dato['Antedentes']         ='<label style="color:white;background-color:red">Sí</label>';
        $dato['estado']         = '<button type="button" style="color:white;background-color:#488753" class="pull-right btn btn-default" id="sendEmail">Aprobado
        </button>';
       } else {
        $dato['estado']         = '<button type="button" style="color:white;background-color:#9F4C44" class="pull-right btn btn-default" id="sendEmail">No existe registro
        </button>';
        }
