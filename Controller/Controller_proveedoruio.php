...
<path fill-rule="evenodd" d="M8 3c-1.552 0-2.94.707-3.857 1.818a.5.5 0 1 1-.771-.636A6.002 6.002 0 0 1 13.917 7H12.9A5 5 0 0 0 8 3M3.1 9a5.002 5.002 0 0 0 8.757 2.182.5.5 0 1 1 .771.636A6.002 6.002 0 0 1 2.083 9z"></path>
       ...
       // $dato['Antedentes']         = $movements[$i]['Antedentes'];
     //   $dato['Examen_seguridad']         = $movements[$i]['Examen_seguridad'];
        $dato['Fecha_de_documentacion']         = $movements[$i]['Fecha_documentacion'];
       ...
       if($movements[$i]['Examen_seguridad']=='Aprobado'){
        //SI TIENE
        //$dato['Antedentes']         ='<label style="color:white;background-color:red">Sí</label>';
        $dato['Examen_seguridad']         = '<button type="button" style="color:white;background-color:#009A3F" class="pull-right btn btn-default" id="sendEmail">Aprobado
        </button>';
       } else {
        $dato['Examen_seguridad']         = '<button type="button" style="color:white;background-color:#F39200" class="pull-right btn btn-default" id="sendEmail">No existe registro
        </button>';
        }
