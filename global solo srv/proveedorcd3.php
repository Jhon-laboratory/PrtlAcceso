            ...
            <div class="col-lg-12">
              <div class="card card-primary card-outline">
                ...
                <div class="col-sm-2 col-md-2 col-lg-2">
                      <div class="form-group">
                        <strong>Seleccione el CD a filtrar</strong>
                        <select  id="search" name="search" class="form-control"   style="width: 100%;">
                        <option>Babahoyo CD</option>
                        <option>Milagro CD</option>
                        <option>Machala CD</option>
                        <option>Manta CD</option>
                        </select>
                      </div>
                  </div>
                          ...
                          <table id="table_clientes" class="table  table-bordered text-center tabla_detalle_fp">
                            <thead>
                              ...
                              <th style="width:10px">#</th>
                                ...
                                <th style="width:2px">Antecedentes</th>
                                ...
                                <th style="width:10px">CD</th> <!--ANUAL X ACTIVO O CADUCADO-->
...
<script src="../../plugins/dropzone/min/dropzone.min.js"></script>
  ...
  <script src="./js/portalaccesocd3.js"></script>
</body>
...
<script>
 ...
 $.each($("#table_clientes tbody tr"), function() {
