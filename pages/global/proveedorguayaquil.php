...
<head>
  ...
  <style>
    ...
    /* DISEÑO DE TARJETAS IDÉNTICO AL DE QUITO */
    .cards-container {
        display: grid;
      ...
      <div class="top_nav">
        <div class="nav_menu">
          <div class="navbar-left">
            ...
            <div class="nav-title">
              <i class="fa fa-building"></i> PORTAL ACCESO - GUAYAQUIL
            </div>
          </div>
      ...
      <div class="right_col" role="main">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12">
            ...
            <!-- CONTENEDOR DE TARJETAS (DISEÑO IDÉNTICO A QUITO) -->
